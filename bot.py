...
guild_ids = [1087996443547156530]

load_dotenv()
discord_token = os.environ.get('PASTE_YOUR_DISCORD_BOT_TOKEN')
...
async def on_ready():
    print("Bot connected")
    await client.get_channel(1087996444084015117).send('/imagine prompt train')
